...
class FormKehamilan extends StatefulWidget {
  const FormKehamilan({super.key});

  @override
  State<FormKehamilan> createState() => _FormKehamilanState();
}

class _FormKehamilanState extends State<FormKehamilan> {
  var id = 0;
  ...
  getUser() async {
    ...
    setState(() {
      id = prefs.getInt('id')!;
      nama_ibu = prefs.getString('nama_ibu')!;
      tgl_lahir_ibu = prefs.getString('tgl_lahir_ibu')!;
  ...
  void AddFormHamil(String tanggal_pelayanan, String keluhan) async {
    setState(() {
      isLoading = true;
    });
    try {
      var response = await dio.post(
          'https://posyandu-admin.harysusilo.my.id/api/layanan/ibuHamil',
          data: {
            'user_id': id.toString(),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(nama_ibu, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14),),
                  ),
                ],
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(no_hp, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14),),
                  ),
                ],
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(tgl_lahir_ibu, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 14),),
                  ),
                ],
              ),
